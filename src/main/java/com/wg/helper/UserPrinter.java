...
public class UserPrinter {
    ...
    private static final String HEADER_FORMAT = "%-6s | %-10s | %-10s | %-12s | %-20s | %-10s | %-10s | %-25s | %-30s";
    private static final String ROW_FORMAT = "%-6s | %-10s | %-10s | %-12s | %-20s | %-10s | %-10s | %-25s | %-30s";
    ...
    public static void printUsers(List<User> users) {
        ...
        // Print header
        System.out.printf(HEADER_FORMAT, "Sr.No.", "First Name", "Last Name", "Phone Number", "Email", "Gender", "User Role", "Created At", "Password");
        System.out.println();
